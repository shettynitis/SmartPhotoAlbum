...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://un5f1h9s33.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.photosObjectsPut = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(photosObjectsPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.photosObjectsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var photosObjectsOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/photos/{objects}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(photosObjectsOptionsRequest, authType, additionalParams, config.apiKey);
    };
